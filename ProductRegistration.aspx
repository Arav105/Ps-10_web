<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductRegistration.aspx.cs" Inherits="web_10.ProductRegistration" %>
...
<body>
    ...
    <form id="form1" runat="server">             
        <div class="row">
             <div class="col-md-2"><asp:Image runat="server" ID="Image1" ImageUrl="C:\Users\Admin\Downloads\photo1.jpg"
                 Width="750" Height="200" CssClass="img-fluid" /></div>
             <div class="col-md-2" style="margin-left : 150px"><asp:Image runat="server" ID="Image2" ImageUrl="C:\Users\Admin\Downloads\photo2.jpg"
                 Width="750" Height="200" CssClass="img-fluid" /></div>            
         </div>
